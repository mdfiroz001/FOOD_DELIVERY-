...
$firebaseConfig = [
 "apiKey" => "AIzaSyDSMVtGxNdBFVLGDmup2jztA2aXIx7Sg7Q",
    "authDomain" => "food-delivery-5fdfa.firebaseapp.com",
    "databaseURL" => "https://food-delivery-5fdfa-default-rtdb.firebaseio.com",
    "projectId" => "food-delivery-5fdfa",
    "storageBucket" => "food-delivery-5fdfa.firebasestorage.app",
    "messagingSenderId" => "908604662185",
    "appId" => "1:908604662185:web:808f0c383322d6102664b8"
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($input['email']) && isset($input['otp'])) {
        ...
        $smtp_port = 465; 
        $username  = 'mdabdullah564ad@gmail.com'; 
        $password  = 'sbmsnaimymbazavm';          
        // ============================================================
